  ...
  channels() 
{
  ...
  if (!music) throw string("Couldn't load the music")+Mix_GetError();
 ...
 sounds.push_back( Mix_LoadWAV("sound/fire-ball.wav") );
 sounds.push_back( Mix_LoadWAV("sound/fire-ball-release.wav") );
